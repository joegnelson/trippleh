...
var arrayofCellData = [
    ...
    cellData( text :	"Vegan Beet Lasagna"	, image :#imageLiteral(resourceName:	"BeetLasagna"	), imageUrl:	""	, catDetail:	"Lunch/Dinner"	, restrictions:	"No Sugar Added, Vegan, Vegetarian, Dairy Free"	),
    ...
    cellData( text :	"Vegan No Churn Chocolate Ice Cream"	, image :nil, imageUrl:	"https://mbkr-minimalistbaker.netdna-ssl.com/wp-content/uploads/2014/08/SUPER-Creamy-NO-CHURN-Vegan-Chocolate-Ice-Cream-Just-5-ingredients-and-NATURALLY-sweetened-with-dates1-673x1024.jpg"	, catDetail:	"Ice Cream"	, restrictions:	""	),
    //cellData( text :	"Raw Almond Ricotta"	, image :#imageLiteral(resourceName:	"RawAlmondRicotta"	), imageUrl:	""	, catDetail:	"Sides"	, restrictions:	""	),
    cellData( text :	"Dairy Free Spinach and Artichoke Dip"	, image :nil, imageUrl:	"https://downshiftology.com/wp-content/uploads/2016/02/spinach-artichoke-dip-dairy-free-and-paleo-1.jpg" 	, catDetail:	"Dip"	, restrictions:	""	),]
