...
public class RecipeController extends HttpServlet {
	...
	static {
		...
		Recipe GlutenFreeBananaPeachWalnutPancakes = new Recipe	("1"	,"Gluten Free Banana Peach Walnut Pancakes"	,"GlutenFreeBananaPeachWalnutPancakes"	,"https://ccc-restrictless-login-t1.appspot.com/GlutenFreeBananaPeachWalnutPancakes1.JPG"	,"Breakfast"	,"Gluten Free, Dairy Free, Vegetarian"	,"1 mashed banana,2 eggs,1 teaspoon baking powder,1/2 teaspoon cinnamon,1/2 Chopped walnuts,A pinch of salt", "1. Mash the banana, 2. Combine the eggs with the banana until a homologous mixture, 3. Add in the baking powder, cinnamon and salt and mix to combine, 4. "); 														
