...
public class RecipeController extends HttpServlet {
	...
	static {
		...
		Recipe CookieDoughMacarons = new Recipe	("4"	,"Cookie Dough Macarons"	,"CookieDoughMacarons"	,"https://ccc-restrictless-login-t1.appspot.com/CookieDoughMacarons.png"	,"Batters"	,"Vegetarian, Dairy Free"	,""	,""	);															
		Recipe DFPumpkinRavioli = new Recipe	("5"	,"Dairy Free Pumpkin Ravioli"	,"DFPumpkinRavioli"	,"https://ccc-restrictless-login-t1.appspot.com/DFPumpkinRavioli.jpg"	,"Lunch/Dinner"	,"Dairy Free, Vegetarian, Nut Free"	,""	,""	);															
		Recipe VeganPretzelMonkeyBites = new Recipe	("6"	,"Vegan Pretzel Monkey Bites"	,"VeganPretzelMonkeyBites"	,"https://ccc-restrictless-login-t1.appspot.com/VeganPretzelMonkeyBites.jpg"	,"Doughs"	,"Dairy Free, Nut Free, Vegetarian, Vegan"	,""	,""	);															
